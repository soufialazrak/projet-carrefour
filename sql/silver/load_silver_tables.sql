...
\copy datamarket.product_categories(category_id, category_name)
...
\copy datamarket.transaction_items(
  transaction_id,
  transaction_item_id,
  product_id,
  quantity,
